...
public class CollectLog10 {
    public static void main(String[] args){
        ...
        try {
            BufferedReader bf = new BufferedReader(new FileReader(new File("D:\\ip.txt")));// 路径
            String line = null;
            while((line=bf.readLine())!=null){ Thread.sleep(1000);producer.send(new ProducerRecord<String, String>("gp222", line));
            }
            bf.close();
            producer.close();
